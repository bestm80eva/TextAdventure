...
description_table
	...
	.db 65
	.strz "AFTER SEVERAL ATTEMPTS, YOU MANAGE TO UNLOCK AND OPEN THE DOOR.\n" ; 51
	.db 33
	.strz "YOU HAVE NOTHING TO DO THAT WITH." ; 52
	.db 110
	.strz "FUELED BY THE DRAFT FROM ABOVE, THE LEAVES EVAPORATE IN CLOUD OF ACRID SMOKE WHICH RISES QUICKLY UP THE SHAFT." ; 53
	.db 35
	.strz "YOU CAN'T DO THAT WHILE ON A LADDER" ; 54
	.db 63
	.strz "THE LEAVES SMOLDER A BIT, THEN GO OUT DUE TO THE HIGH HUMIDITY." ; 55
	.db 65
	.strz "LIGHTING A PILE OF LEAVES WHICH YOU ARE CARRYING WOULD BE UNWISE." ; 56
	.db 28
	.strz "YOU HAVE NO IGNITION SOURCE." ; 57
	.db 0
