...
obj_table
	...
	.db 0    ;  flags 1 - 8
	.db 0    ;  flags 9 - 16
	.db 21,0,255,24,255,17,16,243,255,255,243,243,255,255,255,255,0   ; FLOODED TUNNEL
	.db 0    ;  flags 1 - 8
	.db 0    ;  flags 9 - 16
	.db 22,0,255,25,255,255,255,255,21,255,255,255,255,255,255,255,0   ; LARGE CHAMBER
	.db 0    ;  flags 1 - 8
	.db 0    ;  flags 9 - 16
	.db 23,0,255,26,242,242,242,242,255,21,255,255,24,255,255,255,0   ; BASE OF SHAFT
	.db 0    ;  flags 1 - 8
	.db 0    ;  flags 9 - 16
	.db 24,0,255,27,255,255,255,255,255,255,255,255,241,23,255,255,0   ; ON LADDER
	.db 0    ;  flags 1 - 8
	.db 0    ;  flags 9 - 16
	.db 25,0,255,28,255,255,255,255,255,255,255,255,240,24,255,26,0   ; TOP OF SHAFT
	.db 0    ;  flags 1 - 8
	.db 0    ;  flags 9 - 16
	.db 26,0,255,29,255,255,255,255,255,255,255,255,255,25,255,255,0   ; TOP OF HILL
	.db 0    ;  flags 1 - 8
	.db 0    ;  flags 9 - 16
	.db 27,10,30,0,255,255,255,255,255,255,255,255,255,239,255,255,0   ; PILE OF LEAVES
	.db 0    ;  flags 1 - 8
	.db PORTABLE_MASK|FLAMMABLE_MASK|LIGHTABLE_MASK ; flags 9-16
	.db 28,12,31,0,255,255,255,255,255,255,255,255,255,239,255,255,0   ; TABLE
	...
	.db 30,0,255,0,255,255,255,255,255,255,255,255,255,239,255,255,0   ; PAPERCLIP
	.db 0    ;  flags 1 - 8
	.db PORTABLE_MASK ; flags 9-16
	.db 31,12,255,34,255,255,255,255,255,255,255,255,255,239,255,255,0   ; LOCK
	.db SCENERY_MASK ; flags 1-8
	.db 0    ;  flags 9 - 16
	.db 32,4,36,35,255,255,255,255,255,255,255,255,255,239,255,255,0   ; FLASHLIGHT
	.db 0    ;  flags 1 - 8
	.db PORTABLE_MASK|LIGHTABLE_MASK ; flags 9-16
	.db 33,15,38,37,255,255,255,255,255,255,255,255,255,239,255,255,0   ; WHITE CUBE
	.db 0    ;  flags 1 - 8
	.db PORTABLE_MASK ; flags 9-16
	.db 34,13,40,39,255,255,255,255,255,255,255,255,255,239,255,255,0   ; FILTHY TOILET
	.db CONTAINER_MASK ; flags 1-8
	.db 0    ;  flags 9 - 16
	.db 35,34,255,41,255,255,255,255,255,255,255,255,255,239,255,255,0   ; CHARRED PAPERS
	.db 0    ;  flags 1 - 8
	.db PORTABLE_MASK ; flags 9-16
	...
	.db SCENERY_MASK ; flags 1-8
	.db 0    ;  flags 9 - 16
	.db 44,2,255,53,255,255,255,255,255,255,255,255,255,255,255,255,0   ; SUN
	.db SCENERY_MASK ; flags 1-8
	.db 0    ;  flags 9 - 16
