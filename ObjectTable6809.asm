...
obj_table
	...
	.db 0    ;  flags 1 - 8
	.db 0    ;  flags 9 - 16
	.db 16,0,255,19,255,255,17,21,255,255,255,255,255,255,255,255,0   ; DOWNWARD SLOPING TUNNEL
	.db 0    ;  flags 1 - 8
	.db 0    ;  flags 9 - 16
	...
	.db 0    ;  flags 1 - 8
	.db 0    ;  flags 9 - 16
	.db 20,0,255,23,255,255,255,255,21,255,255,255,255,255,255,255,0   ; PUMP ROOM
	.db 0    ;  flags 1 - 8
	.db 0    ;  flags 9 - 16
	.db 21,0,255,24,20,17,19,255,255,255,22,23,255,255,255,255,0   ; FLOODED TUNNEL
	.db 0    ;  flags 1 - 8
	.db 0    ;  flags 9 - 16
	...
	.db 0    ;  flags 1 - 8
	.db 0    ;  flags 9 - 16
	.db 26,0,255,29,255,255,255,255,255,255,255,255,26,241,255,26,0   ; TOP OF HILL
	.db 0    ;  flags 1 - 8
	.db 0    ;  flags 9 - 16
	.db 27,10,30,0,255,255,255,255,255,255,255,255,255,241,255,255,0   ; LEAVES
	.db 0    ;  flags 1 - 8
	.db PORTABLE_MASK|FLAMMABLE_MASK|LIGHTABLE_MASK ; flags 9-16
	.db 28,12,31,0,255,255,255,255,255,255,255,255,255,241,255,255,0   ; TABLE
	...
	.db 30,0,255,0,255,255,255,255,255,255,255,255,255,241,255,255,0   ; PAPERCLIP
	.db 0    ;  flags 1 - 8
	.db PORTABLE_MASK ; flags 9-16
	.db 31,12,255,34,255,255,255,255,255,255,255,255,255,241,255,255,0   ; LOCK
	.db SCENERY_MASK ; flags 1-8
	.db 0    ;  flags 9 - 16
	.db 32,4,36,35,255,255,255,255,255,255,255,255,255,241,255,255,0   ; FLASHLIGHT
	.db 0    ;  flags 1 - 8
	.db PORTABLE_MASK|LIGHTABLE_MASK|EMITTING_LIGHT_MASK ; flags 9-16
	.db 33,15,38,37,255,255,255,255,255,255,255,255,255,241,255,255,0   ; WHITE CUBE
	.db 0    ;  flags 1 - 8
	.db PORTABLE_MASK ; flags 9-16
	.db 34,13,40,39,255,255,255,255,255,255,255,255,255,241,255,255,0   ; FILTHY TOILET
	.db CONTAINER_MASK ; flags 1-8
	.db 0    ;  flags 9 - 16
	.db 35,34,255,41,255,255,255,255,255,255,255,255,255,241,255,255,0   ; CHARRED PAPERS
	.db 0    ;  flags 1 - 8
	.db PORTABLE_MASK ; flags 9-16
