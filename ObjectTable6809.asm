...
obj_table
	...
	.db OPENABLE_MASK|LOCKABLE_MASK ; flags 1-8
	...
	.db 0    ;  flags 1 - 8
	.db 0    ;  flags 9 - 16
	.db 17,0,255,20,19,18,12,16,255,255,255,255,255,255,255,255,0   ; FOUR WAY JUNCTION
	.db 0    ;  flags 1 - 8
	.db 0    ;  flags 9 - 16
	...
	.db 0    ;  flags 1 - 8
	.db 0    ;  flags 9 - 16
	.db 27,10,30,0,255,255,255,255,255,255,255,255,255,241,255,255,0   ; PILE OF LEAVES
	.db 0    ;  flags 1 - 8
	...
	.db 30,29,255,0,255,255,255,255,255,255,255,255,255,241,255,255,0   ; PAPERCLIP
	.db 0    ;  flags 1 - 8
	.db PORTABLE_MASK ; flags 9-16
	.db 31,12,255,34,255,255,255,255,255,255,255,255,255,241,255,255,0   ; LOCK
	.db SCENERY_MASK ; flags 1-8
	.db 0    ;  flags 9 - 16
	.db 32,3,36,35,255,255,255,255,255,255,255,255,255,241,255,255,0   ; FLASHLIGHT
	.db SCENERY_MASK ; flags 1-8
	.db PORTABLE_MASK|LIGHTABLE_MASK|EMITTING_LIGHT_MASK ; flags 9-16
	.db 32,15,38,37,255,255,255,255,255,255,255,255,255,241,255,255,0   ; WHITE CUBE
	.db 0    ;  flags 1 - 8
	.db PORTABLE_MASK ; flags 9-16
	.db 255
